            ...
            <div className={styles.header}>
                ...
                <article className={styles.article}>
                    ...
                    <div className={styles.numeros}>
                        <span>3</span>
                        <p>
                            Generación de ideas: La organización debe desarrollar una lista de ideas/conceptos para atacar los problemas y oportunidades identificadas y priorizadas
                            de acuerdo al visión, plan estratégico y objetivos de la empresa.
                        </p>
                    </div>
                    <div className={styles.numeros}>
                        <span>4</span>
                        <p>
                            Factibilidad: La organización está en el momento de evaluar la factibilidad de sus ideas priorizadas de acuerdo a la visión, plan estratétigico y
